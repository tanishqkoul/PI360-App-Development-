...
const StudentAchievementDetails = () => {
  ...
  useEffect(() => {
    ...
    const apiUrl = `https://pi360.net/site/api/api_student_achievements_details.php?institute_id=mietjammu&rs=${achievementId}`;
    ...
    axios
      ...
      .catch((error) => {
        console.error('Error fetching student achievement details:', error);
        setLoading(false);
      });
  }, []);
